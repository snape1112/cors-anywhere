...
function parseURL(req_url) {
  ...
  parsed.path = parsed.path.replace('%23', '#');
  parsed.pathname = parsed.pathname.replace('%23', '#');
  parsed.href = parsed.href.replace('%23', '#');
  return parsed;
}

// var req_url = 'https://cors-anywhere-snape.herokuapp.com/https://tableau.lincare.com/site/%23/SharedAnalytics/home';
// console.log(parseURL(req_url))
